...
def MakeFSFCELL ():
  ...
  # soma
  cell.soma.insert('A')
  cell.soma.gmax_A = 198*0.1/cell.soma(0.5).area()
  cell.soma.VhlfMaxm_A = 13
  cell.soma.slopem_A = 9.4
  cell.soma.taum_A =	2
  cell.soma.VhlfMaxh_A = -14
  cell.soma.slopeh_A = -1.9
  cell.soma.tauh_A = 5
  cell.soma.erev_A = -99.5              
  cell.soma.cm = 3.8 
  cell.soma.e_pas = -63 
  cell.soma.g_pas = 0.00015 
  # dend
  cell.dend.cm = cell.getcmdens(cell.dend,8.3,9)
  cell.dend.e_pas = -63
  cell.dend.g_pas = 9*0.1/cell.dend(0.5).area()
  # axon
  cell.axon.cm = cell.getcmdens(cell.axon,8.3,9)
  cell.axon.e_pas = -63
  cell.axon.g_pas = 9*0.1/cell.axon(0.5).area()
  # friesen spiker
  cell.ofths.apdur = 0.6 #action potential duration in ms
  cell.ofths.refrac = 1e3/350 #absolute refractory period - 350Hz max frequency
  cell.ofths.gkbase = 0.058 # 58nS == 0.058uS
  cell.ofths.gkinc = 0
  cell.ofths.taugka = 1 #set it to 1 so no div by zero
  cell.ofths.tauk = 1.5
  cell.ofths.vth = -40
  cell.ofths.vthinc = 0
  cell.ofths.tauvtha = 1
  cell.ofths.gnamax = 0.3 # 300nS == 0.3uS
  cell.ofths.ena = 55
  cell.ofths.ek = -91
  cell.ofths.gkmin = 1e-5 # 0.01nS == 0.00001uS
  return cell
