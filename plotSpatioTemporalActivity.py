...
for t in range(1,len(t1)):
    ...
    pcm2 = ax[1].imshow(V1act[:,:,t],cmap='gray', vmin=0, vmax=max_spks)
    ax[1].set_xlim(-0.5,19.5)
    ax[1].set_ylim(-0.5,19.5)
    ax[1].set_title('Excit V1')
    ax[2].imshow(V4act[:,:,t],cmap='gray', vmin=0, vmax=max_spks)
    ax[2].set_xlim(-0.5,9.5)
    ax[2].set_ylim(-0.5,9.5)
    ax[2].set_title('Excit V4')
    ax[3].imshow(ITact[:,:,t],cmap='gray', vmin=0, vmax=max_spks)
    ...
    ax[6].imshow(IV4act[:,:,t],cmap='gray', vmin=0, vmax=max_spks)
    ax[6].set_xlim(-0.5,4.5)
    ax[6].set_ylim(-0.5,4.5)
    ax[6].set_title('Inhib V4')
    ax[7].imshow(IITact[:,:,t],cmap='gray', vmin=0, vmax=max_spks)
